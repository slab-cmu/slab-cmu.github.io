...
| 3    | 9/10  | Benchmarking Efficiency   | Lab 1 due; Lecture highlight. |
|      | 9/12  | Natural language processing  | |
...
|      | 9/26  | Compression II: Pruning and Distillation  | Project proposals due; Lecture highlight. |
| 6    | 10/1  | Neural Architecture Search  | Lecture highlight. |
|      | 10/3  | Architecture-specific tricks I  | Lab 2 due; Lecture highlight. |
| 7    | 10/8  | Architecture-specific tricks I | Lecture highlight. |
|      | 10/10 | Quiz 2 & Project hours: Proposal feedback  | Lab 3: Quantization |
| 8    | 10/15 | *No class: Fall break* | |
|      | 10/17 | *No class: Fall break*  |  |
| 9    | 10/22 | Project sharing | |
|      | 10/24 | Project sharing | Project sharing writeup due |
| 10   | 10/29 | Project Feedback | Lab 3 Due |
|      | 10/31 | Guest lecture | Lecture highlight |
| 11   | 11/5  | *No class: Democracy day* | |
|      | 11/7  | Quiz 3 & Project hours  | Lab 4: Pruning |
| 12   | 11/12 | Efficient training (or don't) | Lecture highlight |
|      | 11/14 | Parameter efficient fine-tuning  | Lecture highlight |
| 13   | 11/19 | Embeddings, retrieval and RAG | Lecture highlight |
|      | 11/21 | Quiz 4 & Project hours  | Lab 4 Due |
| 14   | 11/26 | *No class: Should be Thanksgiving break* | |
|      | 11/28 | *No class: Thanksgiving break*  | |
| 15   | 12/3  | ML and the Environment | Lecture highlight |
|      | 12/5  | Final presentations & hardware return  | Lab 3: Quantization |
|      | TBD   | Final deadline for hardware return.  | |
...
- **Lecture highlights (20 points).** (11 assignments; 2 points each. Lowest grade dropped. Individual.) Lecture highlights are meant to be lightweight assignments to help encourage engagement in and reflection on class lectures by writing few sentences describing key takeaways from the lecture. Not all lectures have an associated highlight. 
...
- **Project (32 points).** (Group.) A semester-long 3-4 person team project focused on deploying a machine learning model on a low-compute device (SBC). More details above and in class. There will be intermediate assignments (project proposal, project sharing) as well as a final presentation and report.
